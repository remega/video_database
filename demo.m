...
Video_name='BasketballPass.avi'; %Select the target movie there
load('video_database.mat')
% mov=aviread([VIDEO_DIR Video_name]); 
% movie(mov);    
 ...
 for k=1:numFrames
	...
	[heatposrow,heatposcol]=find(fixmaptemp>0.3);
